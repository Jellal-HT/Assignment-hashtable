public class TestDict {
	...
	public static void main(String[] args) {
		Dictionary dict = new Dictionary(101);
		DictEntry pair;

		if (args.length == 0 || (args[0].equals("1") || args[0].equals("2") || args[0].equals("3")
				|| args[0].equals("6") || args[0].equals("4") || args[0].equals("5"))) {
			// Test 1: add an entry.
